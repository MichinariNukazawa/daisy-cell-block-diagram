...
node bin/daisy-cell-block-diagram-cli.js fileformat-example/oneblock00.daisydiagram ${DST_PATH}
...
node bin/daisy-cell-block-diagram-cli.js ${SRC_PATH} ${DST_PATH}
rsvg-convert -o ${DST_PATH}.png ${DST_PATH} # check file type is svg.
